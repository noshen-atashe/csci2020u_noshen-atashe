             ...
             ConstantVisitor
{
     ...
     * @param adaptKotlin             is Kotlin support turned on?
     */
    ...
    private boolean isNumericClassName(Clazz innerClass, String innerClassName, String outerClassName)
    {
        if (adaptKotlin)
        {
            // If this is a Kotlin synthetic lambda class then we know it's numeric.

            // Kotlin synthetic lambda classes that were named based on the location that they
            // were inlined from may be named like OuterClass$methodName$1 where $methodName$1
            // is the inner class name. We can rename this class to OuterClass$1 but the default
