...
implements   KotlinMetadataVisitor
{
                                                  ...
                                                  KotlinSyntheticClassKindMetadata kotlinSyntheticClassKindMetadata)
    {
        ...
        {
            String originalName = newClassName(kotlinSyntheticClassKindMetadata.referencedClass);

            if (!originalName.endsWith(WHEN_MAPPINGS_SUFFIX))
            {
                setNewClassName(kotlinSyntheticClassKindMetadata.referencedClass, originalName + WHEN_MAPPINGS_SUFFIX);
            }
        }
        else if (kotlinSyntheticClassKindMetadata.kind == KotlinSyntheticClassKindMetadata.Kind.LAMBDA)
        {
            kotlinSyntheticClassKindMetadata.referencedClass.accept(
