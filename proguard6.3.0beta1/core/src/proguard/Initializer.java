...
public class Initializer
{
                        ...
                        ClassPool libraryClassPool) throws IOException
    {
        ...
        if (configuration.adaptKotlinMetadata)
        {
            ...
            libraryClassPool.classesAccept(new ReferencedKotlinMetadataVisitor(
                                           new MultiKotlinMetadataVisitor(
                                           new KotlinInterClassReferenceInitializer(libraryClassPool,
                                                                                    kotlinInitializationWarningPrinter),
                                           new KotlinDefaultMethodInitializer(libraryClassPool,
                                                                              kotlinInitializationWarningPrinter),
                                           new KotlinDefaultImplsInitializer(libraryClassPool,
                                                                             kotlinInitializationWarningPrinter))));
            ...
            if (configuration.enableKotlinAsserter)
            {
                ClassVisitor kotlinAsserter =
                    ...
                    new KotlinMetadataAsserter(programClassPool, libraryClassPool, kotlinInitializationWarningPrinter));
        ...
        if (configuration.adaptKotlinMetadata)
        {
            ...
            if (kotlinInitializationWarningCount > 0)
            {
                ...
                err.println("Warning: there were " + kotlinInitializationWarningCount +
                            " errors during Kotlin metadata initialization.");
            }
        }
