...
import proguard.classfile.kotlin.fixer.KotlinAnnotationFlagFixer;
import proguard.classfile.util.*;
import proguard.classfile.instruction.visitor.InstructionCounter;
import proguard.classfile.kotlin.KotlinMetadataWriter;
...
{
    public static final String VERSION = "ProGuard, version 6.3.0 beta1";
    ...
    public void execute() throws IOException
    {
            ...
            configuration.adaptKotlinMetadata)
        {
            initialize();
            mark();
            // TODO mark kotlin metadata as well, based on its own ruleset?
        }
    ...
    private void adaptKotlinMetadata()
    {
        ...
        //TODO where should this annotation flag fixing go? Is it enough
        //     to do it just once at the end?
        ...
        programClassPool.classesAccept(
            new ReferencedKotlinMetadataVisitor(
            new KotlinMetadataWriter(counter)));
